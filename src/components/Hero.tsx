import { Phone, Shield, Clock } from '@phosphor-icons/react';
import { motion } from 'motion/react';

export default function Hero() {
  return (
    <section id="home" className="bg-zinc-950 text-white pt-20 pb-32 relative overflow-hidden min-h-[100dvh] flex items-center">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 w-full relative z-10">
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-16 items-center">
          ...
          >
            ...
            >
              <Shield weight="fill" className="w-4 h-4 text-emerald-400" />
              <span className="text-sm text-emerald-400 font-medium tracking-tight">Licensed & Insured Electricians</span>
            </motion.div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter leading-none">
              Professional Electrical<br />
              <span className="text-emerald-400">Services You</span><br />
              Can Trust
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <motion.a
                ...
                className="flex items-center gap-3 bg-emerald-500 text-zinc-950 px-8 py-5 rounded-2xl font-semibold hover:bg-emerald-400 transition-all duration-300 shadow-[0_0_30px_rgba(16,185,129,0.3)] hover:shadow-[0_0_40px_rgba(16,185,129,0.5)] min-h-[60px] group"
                whileHover={{ scale: 1.02, y: -2 }}
                whileTap={{ scale: 0.98 }}
              >
                <div className="bg-zinc-950 p-2 rounded-lg group-hover:scale-110 transition-transform duration-300">
                  <Phone weight="fill" className="w-6 h-6 text-emerald-400" />
                </div>
            ...
            <div className="flex flex-wrap items-center gap-8 pt-4 border-t border-zinc-800">
              <div className="flex items-center gap-2 text-zinc-400">
                <Clock weight="fill" className="w-5 h-5 text-emerald-400" />
          ...
          {/* Right: Image with Liquid Glass Card */}
          <motion.div
          ...
          >
            <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden border border-zinc-800 shadow-[0_20px_80px_-20px_rgba(0,0,0,0.5)] relative">
              <img
                src="https://picsum.photos/seed/electrician-pro/800/1000"
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-emerald-500/3 rounded-full blur-[100px]" />
      </div>
    </section>
  );
}
